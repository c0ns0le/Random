...
sleep 5
rsync -ahDHAX --stats --delete-after --progress -e "sudo -u jaw171 ssh -l white -p 4422" --rsync-path="sudo rsync" /home/jaw171/VM/jaw171-winbox2b gimpy530.dyndns.org:/media/Data/Backup/$linclient/VM/
